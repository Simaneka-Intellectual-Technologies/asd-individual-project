                            ...
                            <div class="trending-top mb-30">
                                <div class="trend-top-img">
                                    ...
                                    <div class="trend-top-cap">
                                        ...
                                        <h2>
                                            <a href="#">Welcome To The Best Model Winner<br />
                                    ...
                                    <div class="col-lg-4">
                                        <div class="single-bottom mb-35">
                                            ...
                                            <div class="trend-bottom-cap">
                                                ...
                                                <h4>
                                                    <h4>
                                                        <a href="#">Get the Illusion of Fuller Lashes by
                                                            “Mascng.”</a>
                                                    </h4>
                                                </h4>
                                            </div>
                    ...
                    <div class="col-12">
                        <div class="video-items-active">
                            <div class="video-items text-center">
                                <iframe autoplay="false" src="./assets/videos/Synergi_Logo_Animation1.mp4"
                                    frameborder="0"
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-5 col-sm-6">
                        <div class="single-footer-caption mb-50 mt-60">
                            ...
                            <div class="instagram-gellay">
                                <ul class="insta-feed">
                                    <li>
                                        <a href="#" class="insta-ad-anchor skeleton"><img class="insta-ad-img" src=""
                                                alt="" /></a>
                                    </li>
                                    <li>
