...
<head>
  ...
  <title>ASD News - 215064747 - Varde Daniel</title>
...
<body>
            ...
            <div class="row d-flex align-items-center">
              ...
              <div class="col-xl-9 col-lg-9 col-md-9">
                <div class="header-banner f-right">
                  <a href="" class="header-banner-anchor skeleton">
              ...
              <div class="trending-top mb-30">
                <div class="trend-top-img">
                  ...
                  <div class="trend-top-cap">
                    ...
                    <h2>
                      <a href="details.html">Welcome To The Best Model Winner<br />
                ...
                <div class="row">
                  <div class="col-lg-4">
                    <div class="single-bottom mb-35">
                      <a href="" class="middleStory-anchor skeleton">
                        <div class="trend-bottom-img mb-30">
                          <img class="middleStory-img" src="" alt="" />
                        </div>
                        <div class="trend-bottom-cap">
                          <span class="color1">Lifestyple</span>
                          <h4>
                            <a href="details.html">Advertisement</a>
                          </h4>
                        </div>
                      </a>
                    </div>
                  ...
                  <div class="col-lg-4">
                    <div class="single-bottom mb-35">
                      ...
                      <div class="trend-bottom-cap">
                        ...
                        <h4>
                          <h4>
                            <a href="details.html">Get the Illusion of Fuller Lashes by
                              “Mascng.”</a>
                          </h4>
                        </h4>
                      </div>
        ...
        <div class="row">
                  ...
                  <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                      ...
                      <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab"
                        aria-controls="nav-profile" aria-selected="false">Lifestyle</a>
                      ...
                      <a class="nav-item nav-link" id="nav-technology" data-toggle="tab" href="#nav-techno" role="tab"
                        aria-controls="nav-contact" aria-selected="false">Technology</a>
                    </div>
                  </nav>
                  <!--End Nav Button  -->
                </div>
                      ...
                      <div class="row">
                        <div class="col-lg-6 col-md-6">
                          <div class="single-what-news mb-100">
                            <a href="" class="dark-square-anchor skeleton">
                              <div class="what-img">
                                <img src="" class="dark-square-img" alt="" />
                              </div>
                              <div class="what-cap">
          ...
          <div class="col-lg-4">
            ...
            <div class="news-poster d-none d-lg-block">
              <a href="" class="vertical-strip-anchor skeleton">
                <img class="vertical-strip-img" src="" alt="" />
              </a>
            </div>
          </div>
        </div>
          ...
          <div class="col-12">
            <div class="video-items-active">
              <div class="video-items text-center">
                <iframe autoplay="false" src="./assets/videos/Synergi_Logo_Animation1.mp4" frameborder="0"
            ...
            <div class="col-lg-12">
              <div class="video-caption">
                <div class="top-caption">
                  <span class="color1">Advertisement</span>
                </div>
                <div class="bottom-caption">
                  <a href="" class="thick-horizontal-anchor skeleton">
                    <img src="" class="thick-horizontal-img" alt="" width="100%">
                  </a>
                </div>
              </div>
            </div>
          ...
          <div class="col-xl-3 col-lg-3 col-md-5 col-sm-6">
            <div class="single-footer-caption mb-50 mt-60">
              ...
              <div class="instagram-gellay">
                <ul class="insta-feed">
                  <li>
                    <a href="#" class="insta-ad-anchor skeleton"><img class="insta-ad-img" src="" alt="" /></a>
                  </li>
                  <li>
            ...
            <div class="col-lg-6">
              <div class="footer-copy-right">
                <p>
                  ...
                  <a href="https://simaneka.com" target="_blank">Simaneka Intellectual Technology</a>
                </p>
              </div>
            </div>
            <div class="col-lg-6">
  ...
  <script>
    window.onload = (event) => {
      ...
      var headerAdAnchor = document.querySelector('.header-banner-anchor'),
        headerAdImage = document.querySelector('.header-banner-img'),
        middleStoryAdAnchor = document.querySelector('.middleStory-anchor'),
        middleStoryAdImage = document.querySelector('.middleStory-img'),
        VerticalAdAnchor = document.querySelector('.vertical-strip-anchor'),
      ...
      function loadAd(type, tags, imgElement, anchorTag) {
        ...
        ajax.addEventListener("load", function (event) {
          completeHandler(event, imgElement, anchorTag);
        }, false);

        ajax.open("POST", "https://ad.simaneka.com/api/get");
        ajax.setRequestHeader("authorisation", "");

        ajax.send(formdata);

      }

      function completeHandler(event, imgElement, anchorTag) {
        var response = JSON.parse(event.target.responseText);

        console.log(response)
        imgElement.src = response.link;
        imgElement.alt = response.alt;
        anchorTag.href = response.href;
      }
